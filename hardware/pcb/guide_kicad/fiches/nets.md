...
83 nets distincts. **Utilise ces noms exacts en labels globaux** dans le schéma : c'est ce qui garantit que ton netlist correspond à celui de la carte du repo.

> ⚠️ Nets à une seule broche (à vérifier / points de test, normal ici) : `CAM_GPIO`, `CHRG_N`, `GPIO0`, `LED_DOUT`, `STDBY_N`, `TOF_INT`

| Net | Broches (ref.pad) |
|-----|-------------------|
| `3V3` | C12.1, C13.1, C14.1, C15.1, C16.1, C17.1, C18.1, C19.1, C20.1, C21.1, C22.1, C23.1, C24.1, C25.1, C26.1, C27.1, C28.1, C29.1, C30.1, C31.1, C32.1, C33.1, C36.1, C4.1, J10.4, J3.1, J3.8, J4.15, J9.1, L1.2, R10.1, R16.1, R17.1, R18.1, R19.1, R20.1, R21.1, R4.1, R9.1, U1.9, U1.21, U1.62, U1.85, U1.96, U1.75, U1.77, U1.101, U1.102, U1.51, U10.4, U3.3, U6.5, U6.8, U7.5, U7.6, U7.8, U8.1, U8.11, U9.1, U9.8 |
| `3V3_EN` | R6.1, U5.1 |
