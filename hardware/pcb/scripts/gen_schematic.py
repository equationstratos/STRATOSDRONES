...
SCHEMA_OUT = os.path.join(PCB_DIR, "stratosdrone.kicad_sch")
...
def generate_schematic():
  ...
  (title_block
    ...
    (comment 1 "Autonomous quadcopter platform")
    (comment 2 "Generated from design.py")
    (comment 3 "Linked to stratosdrone.kicad_pcb")
  )
...
def configure_3d_models():
    ...
    kicad_pro = os.path.join(PCB_DIR, "stratosdrone.kicad_pro")
