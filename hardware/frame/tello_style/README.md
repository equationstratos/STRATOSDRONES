...
thin-wall motor mounts, **open Eiffel-truss arms**, a faceted hex-vented canopy
(solid over the lens) and a chamfered camera nose. The pod is sized to the
**real mainboard** (38 × 74 mm, M2 mounts at 28 × 64 — straight from `design.py`
`BOARD`); the 1S pack sits on top of the board, held by a **cradle moulded into
...
a **28 × 64 mm** pitch (matching the board's real holes), filleted with a screw
lead-in. Press the 8520 motors into the round mounts, route the wires through
...
**open Eiffel-truss arms** (triangulated lattice), rounder pod, thinner
...
|---|---|---|
| `body_bottom` | 13.6 cm³ | **16.8 g** |
| `body_top` | 6.9 cm³ | **8.5 g** (incl. battery cradle) |
| **Frame total** | 20.5 cm³ | **≈ 25 g** |
