...
SCHEMA_OUT = os.path.join(PCB_DIR, "stratos_fpv_aio.kicad_sch")
...
def configure_3d_models():
    ...
    kicad_pro = os.path.join(PCB_DIR, "stratos_fpv_aio.kicad_pro")
