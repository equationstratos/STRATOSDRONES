...
Verifies, against stratos_tinyhoop_aio.kicad_pcb:
...
BRD = os.path.join(PCB_DIR, "stratos_tinyhoop_aio.kicad_pcb")
PINMAP_H = os.path.join(REPO, "firmware", "components", "board", "include", "board_pinmap_tinyhoop.h")
